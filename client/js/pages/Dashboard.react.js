    ...
    return (
      <article>
        <section className="text-section">
          ...
          <p>If you registered a new user, the credentials are now securely saved to sessionStorage. The next time you visit the website with this browser, you will be able to login with that username/password combination.</p>
        </section>
      </article>
    );
  }
